...
class ImageConverterTest {
    ...
    private static final String SOURCE_IMAGE = "src/main/resources/pika_pika.jpg";
    private static final String OUTPUT_IMAGE = "src/main/resources/pika_pika_copy.jpg";
