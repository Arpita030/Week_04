...
public class Test_CourseManagementSystem_03 {
    ...
    void testingExamCourse(){
        ExamCourse examCourse1=new ExamCourse("Anshika", 10000);
        String resS=examCourse1.getName();
        double resI=examCourse1.getFees();

        Assertions.assertEquals(10000, resI);
        Assertions.assertEquals("Anshika", resS);
    }
    @Test
    void testingResearchCourse(){
        ResearchCourse researchCourse=new ResearchCourse("Anshika",12000);
    ...
    void testAssignmentCourse(){
        AssignmentCourse assignmentCourse=new AssignmentCourse("Anshika",15000);
    ...
    void testCourse(){
        ...
        Assertions.assertEquals("Anshika", course1.getName());
    }
    @AfterAll
    static void testDepartment(){
        ...
        ExamCourse examCourse=new ExamCourse("Anshika", 10000);
